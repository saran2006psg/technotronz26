...
const workshops = [
  {
    id: "w-01",
    title: "Workshop 1",
    description: "Dive into the unknown depths of emerging technology. Classified briefing on advanced systems.",
    label: "W-01",
  },
  {
    id: "w-02",
    title: "Workshop 2",
    description: "Explore the parallel dimensions of innovation. Hands-on experiments with cutting-edge tools.",
    label: "W-02",
  },
  {
    id: "w-03",
    title: "Workshop 3",
    description: "Unlock hidden potentials in the realm of tech. Secrets from the Upside Down revealed.",
    label: "W-03",
  },
]
